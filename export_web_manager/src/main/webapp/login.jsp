    ...
    <div class="login-box-body">
        ...
        <form action="/login.do" method="post">
            <div class="form-group has-feedback">
                <%--方便测试，将邮箱密码写死--%>
                <input type="email" name="email" class="form-control" placeholder="Email" value="xm@sangou.com">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" name="password" class="form-control" placeholder="密码" value="111">
