            ...
            <div class="table-box">
                ...
                <div class="box-tools pull-right">
                    <div class="has-feedback">
                        <input type="text" class="form-control input-sm" placeholder="输入客户名称搜索" id="search" name="searchCon" value="${searchCon}">
                    ...
                    <script>
                        ...
                        $("#search").keydown(function () {
                            if (event.keyCode == "13"){ //keyCode == "13"
                                ...
                                window.location.href = "/cargo/contract/list.do?searchCon="+searchCon;
                            }
                        });
                    </script>
                </div>
