        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="/system/user/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-2 title" style="font-size: 12px;height: 80px">入职时间</div>
                    <div class="col-md-4 data" style="font-size: 12px;height: 80px">
                    ...
                    <div class="col-md-2 title" style="font-size: 12px;height: 80px">等级</div>
                    <div class="col-md-4 data" style="font-size: 12px;height: 80px">
                        <div class="form-group form-inline">
