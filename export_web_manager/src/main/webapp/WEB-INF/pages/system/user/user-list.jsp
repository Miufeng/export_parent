            ...
            <div class="table-box">
                ...
                <div class="box-tools pull-right">
                    <div class="has-feedback">
                        <input type="text" class="form-control input-sm" placeholder="搜索" id="search" id="search" name="searchCon" value="${searchCon}">
                        <span class="glyphicon glyphicon-search form-control-feedback"></span>
                    </div>
                    <script>
                        //实现回车搜索
                        $("#search").keydown(function () {
                            if (event.keyCode == "13"){ //keyCode == "13"为回车键
                                let searchCon = $("#search").val();
                                if (searchCon != null && searchCon != undefined && searchCon != ""){
                                    window.location.href = "/system/user/list.do?searchCon="+searchCon;
                                }
                            }
                        });
                    </script>
