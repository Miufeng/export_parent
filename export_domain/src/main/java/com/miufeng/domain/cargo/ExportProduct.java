package com.miufeng.domain.cargo;


import com.miufeng.domain.BaseEntity;
...
public class ExportProduct extends BaseEntity implements Serializable {
	...
	private List<com.miufeng.domain.cargo.ExtEproduct> extEproducts = new ArrayList<>();		//报运货物和报运附件的关系，一对多
	...
	public List<com.miufeng.domain.cargo.ExtEproduct> getExtEproducts() {
		return extEproducts;
	}

	public void setExtEproducts(List<com.miufeng.domain.cargo.ExtEproduct> extEproducts) {
