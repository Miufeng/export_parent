...
public class Export extends BaseEntity implements Serializable {
	...
	public List<com.miufeng.domain.cargo.ExportProduct> getExportProducts() {
		return exportProducts;
	}

	public void setExportProducts(List<com.miufeng.domain.cargo.ExportProduct> exportProducts) {
